...
public void OnPluginStart()
{
	...
	{
		SetFailState("Please use the version tailored for Half-Life 2: Deathmatch.");
		LogError("Attempt to load the HL2DM version of \"Change Your Name\" on an unsupported game.");
	}
