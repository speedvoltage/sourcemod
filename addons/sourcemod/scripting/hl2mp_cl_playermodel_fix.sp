...
public void OnPluginStart()
{
	...
	changename_playermodelmsg = CreateConVar("sm_show_playermodel_msg_global", "1", "Shows message that player model was adjusted based on team", 0, true, 0.0, true, 1.0);
