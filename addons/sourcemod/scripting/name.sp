...
/*Plugin Updater*/
#define UPDATE_URL		   "https://raw.githubusercontent.com/speedvoltage/sourcemod/master/addons/sourcemod/name.upd"

/*Plugin Info*/
#define PLUGIN_NAME		   "Change Your Name"
#define PLUGIN_AUTHOR	   "Peter Brev"
#define PLUGIN_VERSION	   "1.8.5.1984" /*Build number since 05/12/18*/
#define PLUGIN_DESCRIPTION "Lets player change their in-game name independently of their Steam name."
...
public void OnClientPostAdminCheck(int client)
{
	...
	if (GetConVarInt(changename_help) == 0) return;
...
public void OnConVarChanged_NameHelp(ConVar convar, const char[] oldValue, const char[] newValue)
{
	if (strcmp(newValue, "1") == 0)
	{
		PrintToServer("[SM] Cvar \"sm_hname_enable\" changed to \"%i\".", GetConVarInt(changename_help));
		PrintToChatAll("[SM] Cvar \"sm_hname_enable\" changed to \"%i\".", GetConVarInt(changename_help));
	}
